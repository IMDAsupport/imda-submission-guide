...
2.  **Sample ID Cross-Reference:**
    * The unique **Sample ID** (e.g., 810, 811) is **generated by the system after you submit this template**.
...
3.  **Accession Numbers:** The **Study ID** is the permanent identifier for your submission. Once validated and publicly released, the temporary ID will be updated to the public **Study Accession Number** (e.g., **IMSXXXX**), which you will use for citations.
...
| **Public** | Study is released and available for download. | None. You can now cite the final IMS ID. |
